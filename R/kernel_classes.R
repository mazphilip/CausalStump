...
KernelClass_SE <- setRefClass("SqExpKernel",
  ...
  methods = list(
    parainit = function(y) {
      ...
      #print(sprintf("parainit --- The parameter list is: %d",p))
      #print(parameters)
    ...
    kernel_mat = function(X1,X2,z1,z2) {
      ...
      #print(sprintf("kernel_mat --- The parameter list is: %d",p))
      #print(parameters)
    ...
    para_update = function(iter,y,X,z,Optim) {
      ...
      #gradients["sigma"]=0 #works
      #gradients["sigma_z"]=0 #works
      #gradients["mu"]=0 #works
      #gradients["lambdaa"]=0 #works?
      
      #gradients["lambdam"]=0
      #gradients["Lm"]=c(0,0) #hard coded
      #gradients["La"]=c(0,0) #hard coded
